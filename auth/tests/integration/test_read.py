...
def test_read(context_fixture, database_connection_fixture):
    ...
    try:
        ...
        assert user.profile.first_name == "Eric"
        assert user.profile.last_name == "Cardozo"
        assert user.profile.birthdate == date(1997, 9, 30)
